...
{
	public class LeftPage : ContentPage
	{
		Tray tray;
		...
		public LeftPage ()
		{
			...
			tray = new Tray (TrayOrientation.Left, 0.5) {
			...
			layout.Children.Add (tray, new Rectangle (-tray.WidthRequest, 0, tray.WidthRequest, App.ScreenHeight));
